...
const generateRandomUsername = () => {
  ...
  const patterns = [
    ...
    () =>
      `${firstNames[Math.floor(Math.random() * firstNames.length)]}_${
    ...
    () =>
      `${["xX", "Xx", ""][Math.floor(Math.random() * 3)]}${
        firstNames[Math.floor(Math.random() * firstNames.length)]
      }${["Xx", "xX", ""][Math.floor(Math.random() * 3)]}`,
    ...
    () =>
      ...
      ].toLowerCase()}${Math.floor(Math.random() * 999) + 1}`,
  ];
                ...
                <div className="flex items-center gap-2 mt-1">
                  ...
                  <span className="text-xs text-gray-400">
                    {isCashed || isFlying
                      ? `@ ${
                          isCashed
                            ? player.actualCashoutMultiplier ||
